...
class EtiDataset(data.Dataset):
    ...
    Note:
        ...
        T: num_frames, seq_len, default=4, number of images to sample in a tracklet
        N: batch_size, default=34
        C, H, W: channel, height, and width
    Args:
        dataset (list): List with items (img_paths, score)
    ...
    def __getitem__(self, index):
        ...
        Args:
            index (int): Index
        Returns:
            tuple: (clip, score) where score is the regress score.
        """
        img_paths, score = self.dataset[index]
